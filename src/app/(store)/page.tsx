...
import RamenMoyashi from '@/images/ramen_moyashi.png'
import NyukaImage from '@/images/nyuka.jpg'
import HinyukaImage from '@/images/hinyuka.jpg'
    ...
    <main>
      ...
      <section className="w-full py-8">
        <div className="grid gap-8 lg:grid-cols-2">
          {[
            { categorySlug: 'nyuka', src: NyukaImage },
            { categorySlug: 'hinyuka', src: HinyukaImage },
